/* eslint-ignore */
// @ts-nocheck
const BINARY_FILE_PATH = new URL('genesis_plus_gx_libretro.wasm', import.meta.url).href,
	moduleDefaults = {
		noInitialRun: !0,
...
export default function(e = {}) {
	...
	function Fe() {
		if (!Fe.called) {
			...
			M[Br() >> 2] = 60 * a, M[Cr() >> 2] = Number(n != o);
			var i = f(r), u = f(t), s = G(i), c = G(u);
			o < n ? (M[Lr() >> 2] = s, M[Lr() + 4 >> 2] = c) : (M[Lr() >> 2] = c, M[Lr() + 4 >> 2] = s);
		}
		function f(e) {
	...
	var Ie = {
		...
		Ne = {
			...
			forceLoadFile: function(e) {
				...
				try {
					e.contents = yr(l(e.url), !0), e.usedBytes = e.contents.length;
				} catch (e) {
					throw new Ne.ErrnoError(29);
				}
			},
	...
	function ar(e, r, t, n, o, a, i) {
		Ge.gamepadEvent || (Ge.gamepadEvent = Sr(1432));
		var u = {
			target: Xe(e),
	...
	function ir(e, r, t, n, o, a, i) {
		Ge.keyEvent || (Ge.keyEvent = Sr(164));
		var u = {
			target: Xe(e),
			allowsDeferredCalls: !0,
			eventTypeString: a,
	...
	function sr(e, r, t, n, o, a, i) {
		Ge.mouseEvent || (Ge.mouseEvent = Sr(64));
		var u = {
			target: e = Xe(e),
	...
	Object.defineProperties(hr.prototype, {
		...
		Ne.FSNode = hr,
		Ne.staticInit();
	for (var Er = 0; Er < 32; ++Er) { Qe.push(new Array(Er)); }
	var wr = new Float32Array(288);
	for (Er = 0; Er < 288; ++Er) { tr[Er] = wr.subarray(0, Er + 1); }
	var br = new Int32Array(288);
	for (Er = 0; Er < 288; ++Er) { nr[Er] = br.subarray(0, Er + 1); }
	function yr(e, r, t) {
	...
	var xr,
		kr = {
			...
			La: function(e, r, n) {
				...
				if (ye.contexts[e].rawFbCanvas && 0 !== r) {
					...
					(ye.contexts[e].rawFbCanvas.width = ye.contexts[e].videoElement.videoWidth,
						...
						ye.contexts[e].rawBuffer = Sr(ye.contexts[e].videoElement.videoWidth * ye.contexts[e].videoElement.videoHeight * 4)),
			...
			Ma: function(e) {
				ye.contexts[e].glTexId && Be(1, ye.contexts[e].glTexId),
					...
					(ye.contexts[e].rawBuffer && (Dr(ye.contexts[e].rawBuffer), ye.contexts[e].rawBuffer = 0, ye.contexts[e].rawFbCanvasCtx = null),
			...
			md: function(e, r, t, n, o, a, i) {
				Ke('getActiveAttrib', e, r, t, n, o, a, i);
			},
			ld: function(e, r, t, n, o, a, i) {
			...
			ib: function(e, r, t, n, o) {
				return void 0 !== (e = Xe(e)).onwheel
					? (function(e, r, t, n, o, a, i) {
						Ge.wheelEvent || (Ge.wheelEvent = Sr(96));
						var u = {
							target: e,
							allowsDeferredCalls: !0,
							eventTypeString: a,
			...
			v: function(e, r, t, n, o, a, i, u, s) {
				mr.texImage2D(e, r, t, n, o, a, i, u, s ? rr(u, i, n, o, s) : null);
			},
			g: Ce,
			M: function(e, r, t, n, o, a, i, u, s) {
				var c = null;
				s && (c = rr(u, i, o, a, s)), mr.texSubImage2D(e, r, t, n, o, a, i, u, c);
			},
			va: function(e, r) {
			...
			ka: function(e) {
				...
				try {
					...
					if (Tr(r), e !== e + 0 && 'longjmp' !== e) { throw e; }
					Pr(1, 0);
				}
			},
			n: function(e, r) {
				...
				try {
					...
					if (Tr(t), e !== e + 0 && 'longjmp' !== e) { throw e; }
					Pr(1, 0);
				}
			},
			p: function(e, r, t) {
				...
				try {
					...
					if (Tr(n), e !== e + 0 && 'longjmp' !== e) { throw e; }
					Pr(1, 0);
				}
			},
			wa: function(e, r, t, n) {
				...
				try {
					...
					if (Tr(o), e !== e + 0 && 'longjmp' !== e) { throw e; }
					Pr(1, 0);
				}
			},
			ta: function(e, r, t, n, o, a) {
				var i = Fr();
				try {
					return X.get(e)(r, t, n, o, a);
				} catch (e) {
					if (Tr(i), e !== e + 0 && 'longjmp' !== e) { throw e; }
					Pr(1, 0);
				}
			},
			eb: function(e) {
				...
				var g = {
					...
					'%W': function(e) {
						var r = new Date(e.tm_year, 0, 1),
							t = 1 === r.getDay() ? r : gr(r, 0 === r.getDay() ? 1 : 7 - r.getDay() + 1),
		...
		_r = (function() {
			...
			function r(e, r) {
				var n = e.exports;
				t.asm = n, q((_ = t.asm.cf).buffer), X = t.asm.gf, ne();
			}
			function n(e) {
				r(e.instance);
			}
			...
			t.___wasm_call_ctors = function() {
				return (_r = t.___wasm_call_ctors = t.asm.df).apply(null, arguments);
			}),
		Dr = t._free = function() {
			return (Dr = t._free = t.asm.ef).apply(null, arguments);
		},
		Sr = t._malloc = function() {
			return (Sr = t._malloc = t.asm.ff).apply(null, arguments);
		},
		Ar = (t._fflush = function() {
			return (t._fflush = t.asm.hf).apply(null, arguments);
		},
			t.___errno_location = function() {
				return (Ar = t.___errno_location = t.asm.jf).apply(null, arguments);
			}),
		Lr = (t._cmd_savefiles = function() {
			return (t._cmd_savefiles = t.asm.kf).apply(null, arguments);
		},
			t._cmd_save_state = function() {
				return (t._cmd_save_state = t.asm.lf).apply(null, arguments);
			},
			t._cmd_load_state = function() {
				return (t._cmd_load_state = t.asm.mf).apply(null, arguments);
			},
			t._cmd_take_screenshot = function() {
				return (t._cmd_take_screenshot = t.asm.nf).apply(null, arguments);
			},
			t._cmd_toggle_menu = function() {
				return (t._cmd_toggle_menu = t.asm.of).apply(null, arguments);
			},
			t._cmd_undo_save_state = function() {
				return (t._cmd_undo_save_state = t.asm.pf).apply(null, arguments);
			},
			t._cmd_undo_load_state = function() {
				return (t._cmd_undo_load_state = t.asm.qf).apply(null, arguments);
			},
			t._main = function() {
				return (t._main = t.asm.rf).apply(null, arguments);
			},
			t.__get_tzname = function() {
				return (Lr = t.__get_tzname = t.asm.sf).apply(null, arguments);
			}),
		Cr = t.__get_daylight = function() {
			return (Cr = t.__get_daylight = t.asm.tf).apply(null, arguments);
		},
		Br = t.__get_timezone = function() {
			return (Br = t.__get_timezone = t.asm.uf).apply(null, arguments);
		},
		Fr = t.stackSave = function() {
			return (Fr = t.stackSave = t.asm.vf).apply(null, arguments);
		},
		Tr = t.stackRestore = function() {
			return (Tr = t.stackRestore = t.asm.wf).apply(null, arguments);
		},
		Mr = t.stackAlloc = function() {
			return (Mr = t.stackAlloc = t.asm.xf).apply(null, arguments);
		},
		Pr = t._setThrew = function() {
			return (Pr = t._setThrew = t.asm.yf).apply(null, arguments);
		},
		Rr = t.dynCall_j = function() {
			return (Rr = t.dynCall_j = t.asm.zf).apply(null, arguments);
		};
	function Or(e) {
		this.name = 'ExitStatus', this.message = 'Program terminated with exit(' + e + ')', this.status = e;
	}
	t.callMain = Ir, t.FS = Ne;
	function Ir(e) {
		var r = t._main, n = (e = e || []).length + 1, o = Mr(4 * (n + 1));
		M[o >> 2] = V(i);
	...
	function Ur(e, r) {
		r && D && 0 === e || (D || (e, ge(K), Ne.quit(), Re.shutdown(), !0, t.onExit && t.onExit(e), S = !0), u(e, new Or(e)));
	}
	if (
		ee = function e() {
			xr || Nr(), xr || (ee = e);
	...
	var zr = !0;
	return t.noInitialRun && (zr = !1), Nr(), t;
}
