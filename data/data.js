 ...
 * @prop {String[]} languages A list of language tags for the languages the material is published.
 * @prop {String} name The name of the material (used in search).
 * @prop {Object} [names] A list with translated names for the material, where the key is a language tag and the value the translated name.
 * *Note:* Some materials are released in multiple languages but have significant changes from the base material, so they are separate.
 ...
 * @prop {"missing"|"outofscope"|"rummored"|"unreleased"|"upcomming"} [status] The status of the item, one of the following:
 *
