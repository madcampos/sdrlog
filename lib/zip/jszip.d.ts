...
declare namespace JSZip {
    ...
    interface JSZipObject {
        ...
        nodeStream(type?: 'nodebuffer', onUpdate?: OnUpdateCallback): ReadableStream;
    }
...
declare class JSZip {
     ...
     * @return JSZip object
     */
    file<T extends JSZip.InputType>(path: string, data: InputByType[T] | Promise<InputByType[T]>, options?: JSZip.JSZipFileOptions): typeof JSZip;
    file<T extends JSZip.InputType>(path: string, data: null, options?: JSZip.JSZipFileOptions & { dir: true }): typeof JSZip;
     ...
     */
    folder(name: string): typeof JSZip | null;
     ...
     */
    remove(path: string): typeof JSZip;
     ...
     * @return Returns promise
     */
    loadAsync(data: InputFileFormat, options?: JSZip.JSZipLoadOptions): Promise<typeof JSZip>;
